...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/diplib-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/diplib-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add diplib diplib-python
# for installing globally
pixi global install diplib diplib-python
```
...
It is possible to list all of the versions of `diplib` available on your platform:
...
```
pixi search diplib --channel conda-forge
```
